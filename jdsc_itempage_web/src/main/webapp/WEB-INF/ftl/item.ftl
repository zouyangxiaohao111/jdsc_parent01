...
<body ng-app="jdsc" ng-controller="itempageController">
            ...
            <div class="py-container">
                <div class="shortcut">
                    ...
                    <ul class="fr">
                        ...
                        <li class="f-item"><a href="home.html" target="_blank">我的交大商城</a></li>
                        <li class="f-item space"></li>
                        <li class="f-item">交大商城会员</li>
                        <li class="f-item space"></li>
                        <li class="f-item">企业采购</li>
                        <li class="f-item space"></li>
                        <li class="f-item">关注交大商城</li>
                        <li class="f-item space"></li>
